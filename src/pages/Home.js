  ...
  render() {
      ...
      return (
        <div
          ...
          style={{
            ...
            paddingBottom: 0,
            borderStyle: 'solid',
            borderColor: (data.called) ? 'transparent' : GLOBALS.orange
          }}
          >
          <h1 className={'App-hall-title'}
            style={{
    ...
    if(alert.length > 0){
      if(alert === 'LOGO'){
        ...
        return (
          <AlertScreen alert={this.state.alert}/>
        )
      }
    } else {
      return (
        <div>
          ...
          <div style={{
            ...
            <div>
              <h1 style={{color: GLOBALS.black, fontWeight: 900}}>LOWER CAMP</h1>
              <div className="App-home-lc">
                {(this.state.lowerHalls.length > 0) ? renLowerHalls : <NoPostsYet/>}
              </div>
            </div>
            <div>
              <h1 style={{color: GLOBALS.black, fontWeight: 900}}>UPPER CAMP</h1>
              <div className="App-home-uc">
                {(this.state.upperHalls.length > 0) ? renUpperHalls : <NoPostsYet/>}
              </div>
              <div style={{
                  width: '65vw',
                  display: 'flex',
